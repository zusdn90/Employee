...
@Controller
@RequestMapping("/country")       // city라고 요청이 들어오면 컨트롤러가 요청을 담당
public class CountryController {
   ...
   public String getMainView()
   {
      ...
      return "country/main";      // 논리적인view로 취급하여 return   
   ...
   public String getListView()
   {
      ...
      return "country/list";      // 논리적인view로 취급하여 return   
   ...
   public String getDetailView()
   {
      ...
      return "country/detail";      // 논리적인view로 취급하여 return   
   ...
   public String getAppendView()
   {
      ...
      return "country/append";      // 논리적인view로 취급하여 return   
   ...
   public String getModifyView()
   {
      ...
      return "country/modify";      // 논리적인view로 취급하여 return   
   ...
   public String getDeleteView()
   {
      ...
      return "country/delete";      // 논리적인view로 취급하여 return   
